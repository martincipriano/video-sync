 ...
 *   - Channel  → buoyvs_channel  (term meta)
 *   - Playlist → buoyvs_playlist (term meta)
 *   - Video    → _buoyvs_video   (post meta)
 *
...
test.describe('Channel – field persistence', () => {
  ...
  test('channel ID appears in the list column (read from buoyvs_channel JSON)', async ({ page }) => {
    await goToChannels(page);
    const id = uniqueId();
...
test.describe('Channel – sync rule persistence', () => {
  test('saved sync rule schedule and action persist on the edit page', async ({ page }) => {
    ...
    const rule = page.locator('.buoyvs-sync-rule').last();
    await rule.locator('.buoyvs-sync-schedule').selectOption('weekly');
    await rule.locator('.buoyvs-action').selectOption('videos_sync_new');
    ...
    const saved = page.locator('.buoyvs-sync-rule').first();
    await expect(saved.locator('.buoyvs-sync-schedule')).toHaveValue('weekly');
    await expect(saved.locator('.buoyvs-action')).toHaveValue('videos_sync_new');
  });
  ...
  test('disabled toggle state persists on the edit page', async ({ page }) => {
    ...
    const rule = page.locator('.buoyvs-sync-rule').last();
    await rule.locator('.buoyvs-action').selectOption('videos_sync_new');
    await rule.locator('.buoyvs-rule-toggle').uncheck({ force: true });
    ...
    await expect(page.locator('.buoyvs-sync-rule').first().locator('.buoyvs-rule-toggle')).not.toBeChecked();
  });
  ...
  test('custom schedule value persists on the edit page', async ({ page }) => {
    ...
    const rule = page.locator('.buoyvs-sync-rule').last();
    await rule.locator('.buoyvs-sync-schedule').selectOption('custom');
    await rule.locator('.buoyvs-custom-sync-schedule').fill('72');
    await rule.locator('.buoyvs-action').selectOption('videos_sync_new');
    ...
    const saved = page.locator('.buoyvs-sync-rule').first();
    await expect(saved.locator('.buoyvs-sync-schedule')).toHaveValue('custom');
    await expect(saved.locator('.buoyvs-custom-sync-schedule')).toHaveValue('72');
    await expect(saved.locator('.buoyvs-custom-sync-schedule')).toBeEnabled();
  });
  ...
  test('"once" schedule value persists on the edit page and keeps custom hours input disabled', async ({ page }) => {
    ...
    const rule = page.locator('.buoyvs-sync-rule').last();
    await rule.locator('.buoyvs-sync-schedule').selectOption('once');
    await rule.locator('.buoyvs-action').selectOption('videos_sync_new');
    ...
    const saved = page.locator('.buoyvs-sync-rule').first();
    await expect(saved.locator('.buoyvs-sync-schedule')).toHaveValue('once');
    await expect(saved.locator('.buoyvs-custom-sync-schedule')).toBeDisabled();
  });
  ...
  test('multiple sync rules persist with correct count in list column', async ({ page }) => {
    ...
    // Rule 1 — enabled
    await page.locator('#buoyvs-add-rule').click();
    const rule1 = page.locator('.buoyvs-sync-rule').nth(0);
    await rule1.locator('.buoyvs-action').selectOption('videos_sync_new');

    // Rule 2 — disabled
    await page.locator('#buoyvs-add-rule').click();
    const rule2 = page.locator('.buoyvs-sync-rule').nth(1);
    await rule2.locator('.buoyvs-action').selectOption('videos_update_all');
    await rule2.locator('.buoyvs-rule-toggle').uncheck({ force: true });
  ...
  test('multiple saved sync rules all appear on the edit page', async ({ page }) => {
    ...
    await page.locator('#buoyvs-add-rule').click();
    await page.locator('.buoyvs-sync-rule').nth(1).locator('.buoyvs-action').selectOption('channel_update_all');
    ...
    await expect(page.locator('.buoyvs-sync-rule')).toHaveCount(2);
  });
  ...
  test('removing the only sync rule clears it from metadata after save', async ({ page }) => {
    ...
    await page.locator('input[name="channel_id"]').fill(`UC${id}`);
    await page.locator('#buoyvs-add-rule').click();
    await page.locator('.buoyvs-sync-rule').last().locator('.buoyvs-action').selectOption('videos_sync_new');
    ...
    await page.locator('.buoyvs-sync-rule').first().locator('.buoyvs-remove-rule').click();
    ...
    await expect(page.locator('.buoyvs-sync-rule')).toHaveCount(0);
  });
  ...
  test('removing one of multiple sync rules removes only that rule after save', async ({ page }) => {
    ...
    await expect(page.locator('.buoyvs-sync-rule')).toHaveCount(1);
    await expect(page.locator('.buoyvs-sync-rule').first().locator('.buoyvs-action')).toHaveValue('channel_update_all');
  });
});
...
test.describe('Channel – condition persistence', () => {
  test('condition field is pre-selected on the edit page', async ({ page }) => {
    ...
    const cond = rule.locator('.buoyvs-condition').last();
    await cond.locator('.buoyvs-condition-field').selectOption('title');
    await cond.locator('.buoyvs-condition-operator').selectOption('contains');
    await cond.locator('.buoyvs-condition-value').fill('Tutorial');
    ...
    const saved = page.locator('.buoyvs-sync-rule').first().locator('.buoyvs-condition').first();
    await expect(saved.locator('.buoyvs-condition-field')).toHaveValue('title');
  });
  ...
  test('condition operator is pre-selected and enabled on the edit page', async ({ page }) => {
    ...
    const cond = rule.locator('.buoyvs-condition').last();
    await cond.locator('.buoyvs-condition-field').selectOption('view_count');
    await cond.locator('.buoyvs-condition-operator').selectOption('greater_than');
    await cond.locator('.buoyvs-condition-value').fill('1000');
    ...
    const saved = page.locator('.buoyvs-sync-rule').first().locator('.buoyvs-condition').first();
    await expect(saved.locator('.buoyvs-condition-operator')).toBeEnabled();
    await expect(saved.locator('.buoyvs-condition-operator')).toHaveValue('greater_than');
  });
  ...
  test('condition value is pre-filled and enabled on the edit page', async ({ page }) => {
    ...
    await cond.locator('.buoyvs-condition-field').selectOption('title');
    await cond.locator('.buoyvs-condition-operator').selectOption('contains');
    await cond.locator('.buoyvs-condition-value').fill('My Saved Value');
    ...
    const saved = page.locator('.buoyvs-sync-rule').first().locator('.buoyvs-condition').first();
    await expect(saved.locator('.buoyvs-condition-value')).toHaveValue('My Saved Value');
    await expect(saved.locator('.buoyvs-condition-value')).toBeEnabled();
  });
  ...
  test('date condition field, operator, and value all persist on the edit page', async ({ page }) => {
    ...
    const cond = rule.locator('.buoyvs-condition').last();
    await cond.locator('.buoyvs-condition-field').selectOption('published_date');
    await cond.locator('.buoyvs-condition-operator').selectOption('after');
    await cond.locator('.buoyvs-condition-value').fill('2024-01-01');
    ...
    const saved = page.locator('.buoyvs-sync-rule').first().locator('.buoyvs-condition').first();
    await expect(saved.locator('.buoyvs-condition-field')).toHaveValue('published_date');
    await expect(saved.locator('.buoyvs-condition-operator')).toHaveValue('after');
    await expect(saved.locator('.buoyvs-condition-value')).toHaveValue('2024-01-01');
  });
  ...
  test('number condition with numeric field type persists correctly', async ({ page }) => {
    ...
    const cond = rule.locator('.buoyvs-condition').last();
    await cond.locator('.buoyvs-condition-field').selectOption('duration');
    await cond.locator('.buoyvs-condition-operator').selectOption('less_than');
    await cond.locator('.buoyvs-condition-value').fill('600');
    ...
    const saved = page.locator('.buoyvs-sync-rule').first().locator('.buoyvs-condition').first();
    await expect(saved.locator('.buoyvs-condition-field')).toHaveValue('duration');
    await expect(saved.locator('.buoyvs-condition-operator')).toHaveValue('less_than');
    await expect(saved.locator('.buoyvs-condition-value')).toHaveValue('600');
  });
  ...
  test('video_id condition field, operator, and value persist on the edit page', async ({ page }) => {
    ...
    const cond = rule.locator('.buoyvs-condition').last();
    await cond.locator('.buoyvs-condition-field').selectOption('video_id');
    await cond.locator('.buoyvs-condition-operator').selectOption('contains');
    await cond.locator('.buoyvs-condition-value').fill('dQw4w9WgXcQ');
    ...
    const saved = page.locator('.buoyvs-sync-rule').first().locator('.buoyvs-condition').first();
    await expect(saved.locator('.buoyvs-condition-field')).toHaveValue('video_id');
    await expect(saved.locator('.buoyvs-condition-operator')).toHaveValue('contains');
    await expect(saved.locator('.buoyvs-condition-value')).toHaveValue('dQw4w9WgXcQ');
  });
});
...
test.describe('Channel – specific metadata persistence', () => {
  test('specific metadata wrapper is visible on edit when an update_specific action was saved', async ({ page }) => {
    ...
    const rule = page.locator('.buoyvs-sync-rule').last();
    await rule.locator('.buoyvs-action').selectOption('channel_update_specific');

    const wrapper = rule.locator('.buoyvs-specific-metadata-wrapper');
    ...
    const savedWrapper = page.locator('.buoyvs-sync-rule').first().locator('.buoyvs-specific-metadata-wrapper');
    await expect(savedWrapper).not.toHaveClass(/buoyvs-hidden/);
  });
  ...
  test('saved video metadata selection appears as a TomSelect item on the edit page', async ({ page }) => {
    ...
    const rule = page.locator('.buoyvs-sync-rule').last();
    await rule.locator('.buoyvs-action').selectOption('videos_update_specific_all');
...
test.describe('Playlist – field persistence', () => {
  ...
  test('playlist ID appears in the list column (read from buoyvs_playlist JSON)', async ({ page }) => {
    await goToPlaylists(page);
    const id = uniqueId();
...
test.describe('Playlist – sync rule persistence', () => {
  test('saved sync rule schedule and action persist on the edit page', async ({ page }) => {
    ...
    const rule = page.locator('.buoyvs-sync-rule').last();
    await rule.locator('.buoyvs-sync-schedule').selectOption('monthly');
    await rule.locator('.buoyvs-action').selectOption('videos_sync_new');
    ...
    const saved = page.locator('.buoyvs-sync-rule').first();
    await expect(saved.locator('.buoyvs-sync-schedule')).toHaveValue('monthly');
    await expect(saved.locator('.buoyvs-action')).toHaveValue('videos_sync_new');
  });
  ...
  test('playlist condition field, operator, and value persist on the edit page', async ({ page }) => {
    ...
    await cond.locator('.buoyvs-condition-field').selectOption('view_count');
    await cond.locator('.buoyvs-condition-operator').selectOption('greater_than');
    await cond.locator('.buoyvs-condition-value').fill('500');
    ...
    const saved = page.locator('.buoyvs-sync-rule').first().locator('.buoyvs-condition').first();
    await expect(saved.locator('.buoyvs-condition-field')).toHaveValue('view_count');
    await expect(saved.locator('.buoyvs-condition-operator')).toHaveValue('greater_than');
    await expect(saved.locator('.buoyvs-condition-value')).toHaveValue('500');
  });
  ...
  test('playlist specific metadata persists as a TomSelect item on the edit page', async ({ page }) => {
    ...
    const rule = page.locator('.buoyvs-sync-rule').last();
    await rule.locator('.buoyvs-action').selectOption('playlist_update_specific');
...
test.describe('Video – metabox field persistence', () => {
  test('Buoy Video Sync Video Details metabox is visible on the video edit page', async ({ page }) => {
    await page.goto('/wp-admin/post-new.php?post_type=buoyvs_videos');
    await page.waitForLoadState('networkidle');

    await expect(page.locator('#buoyvs_video_details')).toBeVisible();
    await expect(page.locator('#buoyvs_video_id')).toBeVisible();
    await expect(page.locator('#buoyvs_video_url')).toBeVisible();
  });
  ...
  test('video ID and video URL persist after saving the post', async ({ page }) => {
    ...
    // Fill in the Buoy Video Sync metabox fields
    await page.locator('#buoyvs_video_id').fill(videoYtId);
    await page.locator('#buoyvs_video_url').fill(videoUrl);
    ...
    await expect(page.locator('#buoyvs_video_id')).toHaveValue(videoYtId);
    await expect(page.locator('#buoyvs_video_url')).toHaveValue(videoUrl);
  });
  ...
  test('video ID persists when updated on an existing post', async ({ page }) => {
    ...
    await page.locator('#buoyvs_video_id').fill(`original${id}`);
    await page.locator('#publish').click();
    await page.waitForLoadState('networkidle');

    // Update the video ID
    const updatedId = `updated${id}`;
    await page.locator('#buoyvs_video_id').fill(updatedId);
    await page.locator('#publish').click();
    await page.waitForLoadState('networkidle');

    await expect(page.locator('#buoyvs_video_id')).toHaveValue(updatedId);
  });
});
