	...
	<div class="wpbyvs-channel-tabs-content">
			...
			<div class="wpbyvs-mb-fields">
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'Original Title', 'wpbuoy-video-sync' ); ?></p>
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'Channel', 'wpbuoy-video-sync' ); ?></p>
						<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wpbuoy-video-sync' ); ?></button>
					</div>
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'Published Date', 'wpbuoy-video-sync' ); ?></p>
						<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wpbuoy-video-sync' ); ?></button>
					</div>
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'Duration', 'wpbuoy-video-sync' ); ?></p>
						<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wpbuoy-video-sync' ); ?></button>
					</div>
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'View Count', 'wpbuoy-video-sync' ); ?></p>
						<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wpbuoy-video-sync' ); ?></button>
					</div>
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'Like Count', 'wpbuoy-video-sync' ); ?></p>
						<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wpbuoy-video-sync' ); ?></button>
					</div>
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'Comment Count', 'wpbuoy-video-sync' ); ?></p>
						<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wpbuoy-video-sync' ); ?></button>
					</div>
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'Video Link', 'wpbuoy-video-sync' ); ?></p>
						<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wpbuoy-video-sync' ); ?></button>
					</div>
				...
				<div class="wpbyvs-developer-fields wpbyvs-hidden">
					...
					<div class="wpbyvs-mb-field">
						<div class="wpbyvs-mb-label-row">
							<p class="wpbyvs-mb-label"><?php esc_html_e( 'Video ID', 'wpbuoy-video-sync' ); ?></p>
							<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wpbuoy-video-sync' ); ?></button>
						</div>
					...
					<div class="wpbyvs-mb-field">
						<div class="wpbyvs-mb-label-row">
							<p class="wpbyvs-mb-label"><?php esc_html_e( 'Embed Code', 'wpbuoy-video-sync' ); ?></p>
							<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wpbuoy-video-sync' ); ?></button>
						</div>
		...
		<div class="wpbyvs-channel-tab-panel wpbyvs-hidden" data-panel="sync" role="tabpanel">
			<div class="wpbyvs-mb-fields">
				...
				<?php else : ?>
				<p class="wpbyvs-not-synced-msg"><?php esc_html_e( 'This video has not been synced yet.', 'wpbuoy-video-sync' ); ?></p>
				<?php endif; ?>
