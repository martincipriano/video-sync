...
$_action_labels = array(
	'playlists_sync_new' => __( 'Sync new playlists from this channel', 'yousync' ),
	'videos_sync_new'    => __( 'Sync new videos from this channel', 'yousync' ),
);
		...
		<div class="ys-form-group">
			...
			<select class="ys-select ys-action" id="ys-action-<?php echo esc_attr( $rule_index ); ?>" name="sync_rules[<?php echo esc_attr( $rule_index ); ?>][action]" required>
				<optgroup label="<?php esc_attr_e( 'Playlists', 'yousync' ); ?>">
					<option data-resource="playlist" value="playlists_sync_new" <?php selected( $action, 'playlists_sync_new' ); ?>><?php esc_html_e( 'Sync new playlists from this channel', 'yousync' ); ?></option>
				</optgroup>
				<optgroup label="<?php esc_attr_e( 'Videos', 'yousync' ); ?>">
					<option data-resource="video" value="videos_sync_new" <?php selected( $action, 'videos_sync_new' ); ?>><?php esc_html_e( 'Sync new videos from this channel', 'yousync' ); ?></option>
				</optgroup>
			</select>
