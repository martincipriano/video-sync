	...
	<div class="ys-channel-tabs-content">
			...
			<div class="ys-mb-fields">
				...
				<div class="ys-mb-field">
					<div class="ys-mb-label-row">
						<p class="ys-mb-label"><?php esc_html_e( 'Channel Title', 'yousync-pro' ); ?></p>
						<button type="button" class="ys-copy-sc-btn" data-shortcode="<?php echo esc_attr( '[yousync id="' . $post_id . '" field="channel_title"]' ); ?>"><?php esc_html_e( 'Copy shortcode', 'yousync-pro' ); ?></button>
					</div>
				...
				<div class="ys-mb-field">
					<div class="ys-mb-label-row">
						...
						<button type="button" class="ys-copy-sc-btn" data-shortcode="<?php echo esc_attr( '[yousync id="' . $post_id . '" field="channel_description"]' ); ?>"><?php esc_html_e( 'Copy shortcode', 'yousync-pro' ); ?></button>
					</div>
				...
				<div class="ys-mb-field">
					<div class="ys-mb-label-row">
						...
						<button type="button" class="ys-copy-sc-btn" data-shortcode="<?php echo esc_attr( '[yousync id="' . $post_id . '" field="subscriber_count"]' ); ?>"><?php esc_html_e( 'Copy shortcode', 'yousync-pro' ); ?></button>
					</div>
				...
				<div class="ys-mb-field">
					<div class="ys-mb-label-row">
						...
						<button type="button" class="ys-copy-sc-btn" data-shortcode="<?php echo esc_attr( '[yousync id="' . $post_id . '" field="video_count"]' ); ?>"><?php esc_html_e( 'Copy shortcode', 'yousync-pro' ); ?></button>
					</div>
				...
				<?php if ( $channel_id ) : ?>
				<div class="ys-mb-field">
					<p class="ys-mb-label"><?php esc_html_e( 'Channel Link', 'yousync-pro' ); ?></p>
		...
		<div class="ys-channel-tab-panel ys-hidden" data-panel="images" role="tabpanel">
			...
			<div class="ys-mb-fields">
				...
				<div class="ys-mb-field">
					<div class="ys-mb-label-row">
						<p class="ys-mb-label"><?php esc_html_e( 'Banner Image', 'yousync-pro' ); ?></p>
						<button type="button" class="ys-copy-sc-btn" data-shortcode="<?php echo esc_attr( '[yousync id="' . $post_id . '" field="banner_image"]' ); ?>"><?php esc_html_e( 'Copy shortcode', 'yousync-pro' ); ?></button>
					</div>
				...
				<div class="ys-mb-field">
					<div class="ys-mb-label-row">
						<p class="ys-mb-label"><?php esc_html_e( 'Profile Photo', 'yousync-pro' ); ?></p>
						<button type="button" class="ys-copy-sc-btn" data-shortcode="<?php echo esc_attr( '[yousync id="' . $post_id . '" field="profile_photo"]' ); ?>"><?php esc_html_e( 'Copy shortcode', 'yousync-pro' ); ?></button>
					</div>
			...
			<?php else : ?>
			<p class="ys-not-synced-msg"><?php esc_html_e( 'No images synced yet.', 'yousync-pro' ); ?></p>
			<?php endif; ?>
		</div>
		...
		<div class="ys-channel-tab-panel ys-hidden" data-panel="sync" role="tabpanel">
			<div class="ys-mb-fields">
				...
				<?php else : ?>
				<p class="ys-not-synced-msg"><?php esc_html_e( 'This channel has not been synced yet.', 'yousync-pro' ); ?></p>
				<?php endif; ?>
