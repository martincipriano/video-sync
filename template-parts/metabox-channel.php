	...
	<div class="wpbyvs-channel-tabs-content">
			...
			<div class="wpbyvs-mb-fields">
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'Channel Title', 'wby-video-sync' ); ?></p>
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'Channel Link', 'wby-video-sync' ); ?></p>
						<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wby-video-sync' ); ?></button>
					</div>
		...
		<div class="wpbyvs-channel-tab-panel wpbyvs-hidden" data-panel="images" role="tabpanel">
			...
			<div class="wpbyvs-mb-fields">
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'Banner Image', 'wby-video-sync' ); ?></p>
						<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wby-video-sync' ); ?></button>
					</div>
				...
				<div class="wpbyvs-mb-field">
					<div class="wpbyvs-mb-label-row">
						<p class="wpbyvs-mb-label"><?php esc_html_e( 'Profile Photo', 'wby-video-sync' ); ?></p>
						<button type="button" class="wpbyvs-copy-val-btn"><?php esc_html_e( 'Copy value', 'wby-video-sync' ); ?></button>
					</div>
			...
			<?php else : ?>
			<p class="wpbyvs-not-synced-msg"><?php esc_html_e( 'No images synced yet.', 'wby-video-sync' ); ?></p>
			<?php endif; ?>
		</div>
		...
		<div class="wpbyvs-channel-tab-panel wpbyvs-hidden" data-panel="sync" role="tabpanel">
			<div class="wpbyvs-mb-fields">
				...
				<?php else : ?>
				<p class="wpbyvs-not-synced-msg"><?php esc_html_e( 'This channel has not been synced yet.', 'wby-video-sync' ); ?></p>
				<?php endif; ?>
