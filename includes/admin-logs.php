		...
		<div class="ys-logs">
			...
			<thead>
				<tr>
					...
					<th style="width:15%;"><?php esc_html_e( 'Source', 'yousync' ); ?></th>
					<th style="width:15%;"><?php esc_html_e( 'Name', 'yousync' ); ?></th>
					<th style="width:40%;"><?php esc_html_e( 'Message', 'yousync' ); ?></th>
					<th style="width:15%;"><?php esc_html_e( 'Code', 'yousync' ); ?></th>
				</tr>
			</thead>
			<tbody>
