...
function yousync_render_logs_page(): void {
	...
	<div class="wrap">
		...
		<table class="wp-list-table widefat fixed striped">
			<thead>
				<tr>
					<th style="width:190px;"><?php esc_html_e( 'Time', 'yousync' ); ?></th>
					<th style="width:80px;"><?php esc_html_e( 'Source', 'yousync' ); ?></th>
					<th style="width:150px;"><?php esc_html_e( 'Name', 'yousync' ); ?></th>
					<th><?php esc_html_e( 'Message', 'yousync' ); ?></th>
					<th style="width:130px;"><?php esc_html_e( 'Code', 'yousync' ); ?></th>
				</tr>
			</thead>
			<tbody>
